...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if ($_SESSION['hak_akses'] == 'Administrator') {
    ...
    if ($_GET['module'] == 'peminjaman-alat') { ?>
      <li class="nav-item active">
        <a href="?module=peminjaman-alat">
    ...
    // jika tidak dipilih, menu peminjaman_alat tidak aktif
    else { ?>
      <li class="nav-item">
        <a href="?module=peminjaman-alat">
          <i class="fa fa-tasks"></i>
    ...
    if ($_GET['module'] == 'scan_barcode') { ?>
      <li class="nav-item active">
        <a href="?module=scan_barcode">
    ...
    // jika tidak dipilih, menu scan_barcode tidak aktif
    else { ?>
      <li class="nav-item">
        <a href="?module=scan_barcode">
          <i class="fa fa-qrcode"></i>
    ...
    if ($_GET['module'] == 'barang' || $_GET['module'] == 'tampil_detail_barang' || $_GET['module'] == 'form_entri_barang' || $_GET['module'] == 'form_ubah_barang') { ?>
      <li class="nav-section">
        ...
        <h1 class="text-section">Master</h1>
      </li>
      ...
      <li class="nav-item active submenu">
        ...
        <div class="collapse show" id="barang">
          <ul class="nav nav-collapse">
            ...
            <li>
              <a href="?module=lokasi_rak">
                <span class="sub-item">Lokasi Gudang</span>
              </a>
            </li>
          </ul>
        </div>
    ...
    // jika menu barang keluar (tampil data / form entri) dipilih, menu barang keluar aktif
    if ($_GET['module'] == 'barang_pending' || $_GET['module'] == 'form_entri_barang_pending') { ?>
      <li class="nav-item active">
        <a href="?module=barang_pending">
    ...
    // jika tidak dipilih, menu barang pending tidak aktif
    else { ?>
      <li class="nav-item">
        <a href="?module=barang_pending">
          <i class="fas fa-pause"></i>
    ...
    // jika menu laporan barang pending dipilih, menu laporan barang pending aktif
    if ($_GET['module'] == 'laporan_barang_pending') { ?>
      <li class="nav-item active">
        <a href="?module=laporan_barang_pending">
          <i class="fas fa-file"></i>
          <p>Laporan Barang Pending</p>
        </a>
      </li>
    <?php
    }
    // jika tidak dipilih, menu laporan barang pending tidak aktif
    else { ?>
      <li class="nav-item">
        <a href="?module=laporan_barang_pending">
          <i class="fas fa-file"></i>
  ...
  elseif ($_SESSION['hak_akses'] == 'Marketing') {
    if ($_GET['module'] == 'dashboard') { ?>
      <li class="nav-item active">
        <a href="?module=dashboard">
          <i class="fas fa-home"></i>
