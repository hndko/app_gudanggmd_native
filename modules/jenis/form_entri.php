  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul form -->
        <div class="card-title">Entri Data Kategori Barang</div>
      </div>
      <!-- form entri data -->
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="nama_jenis" class="form-control col-lg-5" autocomplete="off" required placeholder="Masukkan Jenis Barang">
            </div>
