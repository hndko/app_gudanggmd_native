    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        <div class="page-header text-white">
          <!-- judul halaman -->
          <h4 class="page-title text-white"><i class="fas fa-clone mr-2"></i> Kategori Barang</h4>
          <!-- breadcrumbs -->
          <ul class="breadcrumbs">
            <li class="nav-home"><a href="?module=dashboard"><i class="flaticon-home text-white"></i></a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
            <li class="nav-item"><a href="?module=jenis" class="text-white">Kategori Barang</a></li>
            <li class="separator"><i class="flaticon-right-arrow"></i></li>
        ...
        <div class="ml-md-auto py-2 py-md-0">
          ...
          <a href="?module=form_entri_jenis" class="btn btn-primary btn-round mr-2">
            <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Buat Kategori Barang
          </a>
          <!-- tombol export data -->
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul tabel -->
        <div class="card-title">Data Kategori Barang</div>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($mysqli, "SELECT * FROM tbl_jenis ORDER BY id_jenis ASC")
