  ...
  <div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-file-import mr-2"></i> Laporan Barang pending</h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a>Barang pending</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="page-inner mt--5">
      <div class="card">
        <div class="card-header">
          <!-- judul form -->
          <div class="card-title">Filter Data Barang pending</div>
        </div>
        <!-- form filter data -->
        <div class="card-body">
          <form action="?module=laporan_barang_pending" method="post" class="needs-validation" novalidate>
            <div class="row">
              <div class="col-lg-3">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pr-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-pending/cetak.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-warning btn-round btn-block mt-4">
              ...
              <div class="col-lg-2 pl-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-pending/export.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-success btn-round btn-block mt-4">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> Laporan Data Barang pending Tanggal <strong><?php echo $tanggal_awal; ?></strong> s.d. <strong><?php echo $tanggal_akhir; ?></strong>
          </div>
        </div>
        <div class="card-body">
            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Jumlah Barang Pending</th>
              ...
              <tbody>
                ...
                // sql statement untuk menampilkan data dari tabel "tbl_barang_pending", tabel "tbl_barang", dan tabel "tbl_satuan" berdasarkan "tanggal"
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="220"><?php echo $data['barang']; ?></td>
                    ...
                    <td width="60"><?php echo $data['keterangan']; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
