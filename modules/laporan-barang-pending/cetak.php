...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  $html = '<!DOCTYPE html>
          <html>
          <head>
              <title>Laporan Data Barang pending</title>
            <link href="../../assets/css/laporan.css" rel="stylesheet">
          </head>
          <body class="text-dark">
            <div class="text-center">
              <h2>LAPORAN DATA BARANG Pending</h2>
            ...
            <div class="mt-4">
              <table class="table table-bordered" width="100%" cellspacing="">
                <thead class="bg-secondary text-white text-center">
                    ...
                    <th class="text-start">Jumlah pending</th>
  ...
  $dompdf->render();
  // menampilkan file PDF yang dihasilkan ke browser dan berikan nama file "Laporan Data Barang pending.pdf"
  $dompdf->stream('Laporan Data Barang pending.pdf', array('Attachment' => 0));
}
