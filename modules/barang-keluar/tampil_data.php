      ...
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        ...
        <div class="ml-md-auto py-2 py-md-0">
          ...
          <a href="?module=form_entri_barang_keluar" class="btn btn-primary btn-round">
            <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Input Barang Keluar
          </a>
        </div>
      </div>
    </div>
