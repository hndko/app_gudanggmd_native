...
// jika user sudah login, maka jalankan perintah untuk export
  ...
  header("Content-Disposition: attachment; filename=Laporan Data Barang Masuk keluar.xls");
?>
  <!-- halaman HTML yang akan diexport ke excel -->
  <!-- judul tabel -->
  <center>
    <h4>
      LAPORAN DATA BARANG MASUK KELUAR<br>
    </h4>
  </center>
  ...
  <table border="1">
    <thead>
      <tr style="background-color:#6861ce;color:#fff">
        ...
        <th height="30" align="center" vertical="center">Input By</th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.jumlah, a.status, b.nama_barang, c.nama_satuan, a.keterangan, a.inputby
                                      ...
                                      WHERE a.barang = '$id_barang' ORDER BY a.id_transaksi ASC")
      ...
      while ($data = mysqli_fetch_assoc($query)) { ?>
        ...
        <tr>
          ...
          <td width="130"><?php echo $data['status']; ?></td>
          <td width="130"><?php echo $data['keterangan']; ?></td>
          <td width="130"><?php echo $data['inputby']; ?></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
