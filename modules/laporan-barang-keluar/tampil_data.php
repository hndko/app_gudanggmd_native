        ...
        <div class="card-body">
		  ...
		  <th class="text-center">PIC</th>
              ...
              <tbody>
                ...
                $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.pic, a.tanggal, a.barang, a.jumlah, b.nama_barang, c.nama_satuan, a.keterangan, a.inputby
		    ...
		    <td width="70" class="text-center"><?php echo $data['pic']; ?></td>
                    ...
                    <td width="330"><?php echo $data['keterangan']; ?></td>
                    <td width="50"><?php echo $data['inputby']; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
