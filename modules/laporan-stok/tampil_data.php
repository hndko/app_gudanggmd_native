              ...
              <div class="col-lg-5">
                <div class="form-group">
                  ...
                  <select name="stok" class="form-control chosen-select" autocomplete="off" required>
                    ...
                    <option value="Seluruh">Semuanya</option>
                ...
                <tbody>
                  ...
                  while ($data = mysqli_fetch_assoc($query)) { ?>
                    ...
                    <tr>
                      ...
                      <td width="40"class="text-center"><?php echo $data['nama_jenis']; ?></td>
                      <td width="40" class=" text-center"><?php if ($data['stok'] <= $data['stok_minimum']) {
                      ...
                      <td width="50" class="text-center"><a href="?module=tampil_detail_barang&id=<?php echo $data['id_barang']; ?>" class="btn btn-icon btn-round btn-primary btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Detail">
