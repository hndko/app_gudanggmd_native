  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Data barang pending berhasil disimpan.</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Data barang pending berhasil dihapus.</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        <div class="page-header text-white">
          <!-- judul halaman -->
          <h4 class="page-title text-white"><i class="fas fa-pause mr-2"></i> Barang Pending</h4>
          <!-- breadcrumbs -->
        ...
        <div class="ml-md-auto py-2 py-md-0">
          <!-- tombol entri data -->
          <a href="?module=form_entri_barang_pending" class="btn btn-primary btn-round">
  ...
  <div class="page-inner mt--5">
    <div class="card">
      <div class="card-header">
        <!-- judul tabel -->
        <div class="card-title">Data Barang pending</div>
      </div>
      <div class="card-body">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center">Jumlah pending</th>
            ...
            <tbody>
              ...
              $no = 1;
              // sql statement untuk menampilkan data dari tabel "tbl_barang_pending", tabel "tbl_barang", dan tabel "tbl_satuan"
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="50" class="text-center">
                    <div>
                      <!-- tombol hapus data -->
                      <a href="modules/barang-pending/proses_hapus.php?id=<?php echo $data['id_transaksi']; ?>" onclick="return confirm('Anda yakin ingin menghapus data barang pending <?php echo $data['id_transaksi']; ?>?')" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus">
