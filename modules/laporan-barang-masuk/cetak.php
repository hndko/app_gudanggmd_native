...
// jika user sudah login, maka jalankan perintah untuk cetak
  ...
  $html = '<!DOCTYPE html>
          ...
          <body class="text-dark">
            <div class="text-center">
              <h2>LAPORAN DATA BARANG MASUK GUDANG GMD</h2>
            ...
            <div class="mt-4">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <thead class="bg-secondary text-white text-center">
                    ...
                    <th style="border: 1px solid black;">input by</th>
		              </tr>
		            </thead>
  ...
  $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.jumlah, b.nama_barang, c.nama_satuan, a.keterangan, a.inputby
  ...
  while ($data = mysqli_fetch_assoc($query)) {
    ...
    $html .= '		<tr>
                    ...
                    <td style="border: 1px solid black;" width="80" class="text-center"align="center">' . $data['id_transaksi'] . '</td>
                    <td style="border: 1px solid black;" width="60" class="text-center"align="center">' . date('d-m-Y', strtotime($data['tanggal'])) . '</td>
                    <td style="border: 1px solid black;" width="220" class="text-center"align="center">' . $data['barang'] . ' - ' . $data['nama_barang'] . '</td>
                    <td style="border: 1px solid black;" width="50" class="text-center"align="center">' . number_format($data['jumlah'], 0, '', '.') . '</td>
                    <td style="border: 1px solid black;" width="30" class="text-center"align="center">' . $data['nama_satuan'] . '</td>
                    <td style="border: 1px solid black;" width="220"class="text-center"align="center">' . $data['keterangan'] . '</td>
                    <td style="border: 1px solid black;" width="50" class="text-center"align="center">' . $data['inputby'] . '</td>
                  </tr>';
  }
  $html .= '		</tbody>
              </table>
