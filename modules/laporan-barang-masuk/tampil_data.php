            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center">NO. BON-Nama Barang</th>
              ...
              <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="220"class="text-center"><?php echo $data['barang']; ?> - <?php echo $data['nama_barang']; ?></td>
                    <td width="30" class="text-center"><?php echo number_format($data['jumlah'], 0, '', '.'); ?></td>
                    <td width="30"class="text-center"><?php echo $data['nama_satuan']; ?></td>
                    <td width="220"class="text-center"><?php echo $data['keterangan']; ?></td>
                    <td width="30"class="text-center"><?php echo $data['inputby']; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
