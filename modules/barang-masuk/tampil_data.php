      ...
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        ...
        <div class="ml-md-auto py-2 py-md-0">
          ...
          <a href="?module=form_entri_barang_masuk" class="btn btn-primary btn-round">
            <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Input Barang Masuk
          </a>
        </div>
      </div>
    </div>
            ...
            <tbody>
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="200" class="text-center"><?php echo $data['id_transaksi']; ?></td>
                  <td width="100" class="text-center"><?php echo date('d-m-Y', strtotime($data['tanggal'])); ?></td>
                  <td width="220" class="text-center"><?php echo $data['barang']; ?></td>
                  <td width="220" class="text-center"><?php echo $data['nama_barang']; ?></td>
                  <td width="100" class="text-center"><?php echo number_format($data['jumlah'], 0, '', '.'); ?></td>
                  <td width="30"class="text-center"><?php echo $data['nama_satuan']; ?></td>
                  <td width="350"><?php echo $data['keterangan']; ?></td>
                  <td width="50"class="text-center"><?php echo $data['inputby']; ?></td>
