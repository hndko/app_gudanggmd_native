...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Aplikasi Persediaan Barang Gudang Berdikari Poultry" />
    <meta name="author" content="Code Null" />

    <!-- Title -->
    <title>Aplikasi Gudang GMD</title>

    <!-- Favicon icon -->
    <link rel="icon" href="assets/img/logogudang.png" type="image/x-icon" />
        ...
        <div class="logo-header" data-background-color="blue">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              <!-- <img src="./assets/img/logobsj.png" alt="" width="30px" height="30px"> -->
              <span class="text-white">App Gudang GMD</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
              ...
              <li class="nav-item dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)" aria-expanded="false">
                  <div class="avatar-sm-top mt-1">
                    <img src="assets/img/avatar.png" alt="image profile" class="avatar-img rounded-circle">
